...
echo ""
echo "Keep GitHub secrets:"
echo "  VPS_HOST=69.62.84.237"
echo "  VPS_USER=root   # or snagdesk if that user can SSH + run deploy"
echo "  DEPLOY_PATH=/home/snagdesk/apps/PropInspect"
echo "  WEB_ROOT=/home/snagdesk/htdocs/snagdesk.cravingcodetech.in"
echo "  PM2_APP_NAME=propinspect-api"
echo "  VPS_SSH_PRIVATE_KEY / VPS_SSH_KNOWN_HOSTS (or rely on ssh-keyscan)"
